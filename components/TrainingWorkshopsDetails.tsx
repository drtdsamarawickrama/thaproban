...
export default function TrainingWorkshopsDetails() {
  const items = [
    { title: "Media Workshops", desc: "Practical workshops for broadcasting setups, stage lighting setups, and camera angles." },
    { title: "Digital Marketing Bootcamps", desc: "Structured bootcamps to build local strategy blueprints, setups, and tracking templates." },
    { title: "Editing Classes", desc: "Courses covering popular post-processing apps, color pipelines, and motion templates." },
    { title: "Technical Labs", desc: "Interactive exercises with professional hardware rigs, led by experienced technical handlers." },
  ];
