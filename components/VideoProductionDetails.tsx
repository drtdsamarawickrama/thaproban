...
export default function VideoProductionDetails() {
  const items = [
    { title: "Commercials & TV Ads", desc: "Visual storytelling crafted for broadcasting channels and promotional spots." },
    { title: "Corporate Promos", desc: "Short brand videos, profile outlines, and customer testimonial statements." },
    { title: "Cinematic Highlights", desc: "High-end coverage of events, workshops, festivals, and stage layouts." },
    { title: "Post-Production Services", desc: "Editing, dynamic typography, sound design, and expert color corrections." },
  ];
